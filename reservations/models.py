...
class Reservation(models.Model):
    ...
    status = models.CharField(max_length=50, choices=choices.STATUS_OPTIONS, default='confirmed')
    ...
    def save(self, *args, **kwargs):
        if not self.pk:
            ...
            if self.event.number_of_seats < 0:
                raise ValidationError("Not enough seats available for this reservation.")      
            self.event.save()
